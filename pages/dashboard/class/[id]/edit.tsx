...
export default function DashboardClassEdit() {
  return (
    <>
      <Head>
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Edit Kelas</h3>
        ...
        <div className="flex items-center justify-center min-h-screen py-4 px-4 text-center sm:block sm:p-0">
          ...
          <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Yakin akan menghapus kelas? kelas tidak dapat dipulihkan setelah dihapus.
                      Kelas tidak dapat dihapus bila telah berelasi dengan tabel lain.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              <form action="<?= base_url('/classescontrollerName/deleteclassesName'); ?>" method="POST">
                <input type="hidden" name="_delete_" value="<?= $className->id_className; ?>" />
                <button
                  type="button"
